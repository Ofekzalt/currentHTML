...
//             const { title, sizes, caption, price, color } = req.body;

//             // Validate required fields
//             if (!title || !sizes || !caption || !price || !color) {
...
//             await product.remove(); // If using Mongoose middleware (e.g., post-remove hook), it will be triggered here
